...
def attack(char_name: str, char_class: str) -> str:
    """Функция расчета нанесения урона."""
...
def special(char_name: str, char_class: str) -> str:
    """Функция расчета урона от ультимейта."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция аннотации выбранного класса с именем героя."""
    """Инструкция по применению персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция описания выбранного класса."""
    approve_choice: str = ''
    char_class: str = ''
